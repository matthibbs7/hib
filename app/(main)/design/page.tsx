    ...
    return (
        <main className="flex min-h-[calc(100vh-72px)] flex-col p-10 bg-[#161616]">
            <div className="flex-col w-full h-full">
                <p>Projects</p>
                <div className="bg-[#282828] h-[200px] rounded-2xl px-5">
                    <div className="flex w-full h-full gap-x-8">
                        <div
                            onClick={() => router.push("/design/rollsolid")}
                            className="flex-col rounded-md group mt-8 items-center justify-center text-center hover:cursor-pointer hover:scale-[1.04] transition duration-500 w-[80px] h-[80px]">
                            <div className="flex shadow-lg rounded-md ml-auto mr-auto w-[50px] h-[50px]">
                                <Image
                                    src="/rollsolid2.png"
                                    height={50}
                                    width={50}
